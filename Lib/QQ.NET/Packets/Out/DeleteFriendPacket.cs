...
namespace QQ.NET.Packets.Out
{
    ...
    public class DeleteFriendPacket : BasicOutPacket
    {
        ...
        public DeleteFriendPacket(QQUser user) : base(QQCommand.Delete_Friend, true, user) { }
        public DeleteFriendPacket(ByteBuffer buf, int length, QQUser user) : base(buf, length, user) { }
