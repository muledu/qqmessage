...
namespace QQ.NET.Packets.Out
{
    ...
    public class PrivacyDataOpPacket : BasicOutPacket
    {
        ...
        public PrivacyDataOpPacket(QQUser user) : base(QQCommand.Privacy_Data_OP, true, user) { }
        public PrivacyDataOpPacket(ByteBuffer buf, int length, QQUser user) : base(buf, length, user) { }
