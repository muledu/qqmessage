...
namespace QQ.NET
{
    ...
    public class MessageManager
    {
        ...
        /// <param name="fragementSequence">The fragement sequence.</param>
        /// <param name="fontSytle">The font sytle.</param>
        ...
        private void SendReceiveReplyPacket(ReceiveIMPacket imPacket)
        {
            ReceiveIMReplyPacket reply = new ReceiveIMReplyPacket(imPacket.Reply, QQUser);
            reply.Sequence = imPacket.Sequence;
        ...
        /// </summary>
        /// <param name="e">The <see cref="QQ.NET.Events.QQEventArgs&lt;QQ.NET.Packets.In.ReceiveIMPacket&gt;"/> instance containing the event data.</param>
        internal void OnReceiveDuplicatedIM(QQEventArgs<ReceiveIMPacket, OutPacket> e)
        {
            SendReceiveReplyPacket(e.InPacket);
        ...
        /// </summary>
        /// <param name="e">The <see cref="QQ.NET.Events.QQEventArgs&lt;QQ.NET.Packets.In.SystemNotificationPacket&gt;"/> instance containing the event data.</param>
