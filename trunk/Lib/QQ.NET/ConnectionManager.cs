...
namespace QQ.NET
{
    ...
    public class ConnectionManager : IDisposable
    {
        ...
        /// </summary>
        /// <param name="e">The <see cref="QQ.NET.Events.ErrorEventArgs"/> instance containing the event data.</param>
        ...
        /// </summary>
        /// <param name="e">The <see cref="QQ.NET.Events.QQEventArgs&lt;QQ.NET.Packets.In.KeepAliveReplyPacket&gt;"/> instance containing the event data.</param>
