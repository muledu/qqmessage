...
namespace QQ.NET
{
    ...
    public class LoginManager
    {
        ...
        /// </summary>
        /// <param name="e">The <see cref="QQ.NET.Events.QQEventArgs&lt;QQ.NET.Packets.In.RequestLoginTokenReplyPacket&gt;"/> instance containing the event data.</param>
        ...
        /// </summary>
        /// <param name="e">The <see cref="QQ.NET.Events.QQEventArgs&lt;QQ.NET.Packets.In.LoginReplyPacket&gt;"/> instance containing the event data.</param>
