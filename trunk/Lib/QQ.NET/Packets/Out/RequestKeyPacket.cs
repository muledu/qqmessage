...
namespace QQ.NET.Packets.Out
{
    ...
    public class RequestKeyPacket : BasicOutPacket
    {
        ...
        public RequestKeyPacket(QQUser user) : base(QQCommand.Request_Key, true, user) { }
        public RequestKeyPacket(ByteBuffer buf, int length, QQUser user) : base(buf, length, user) { }
