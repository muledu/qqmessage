...
namespace QQ.NET.Packets.Out
{
    ...
    {
        public RequestLoginTokenPacket(QQUser user) : base(QQCommand.Request_Login_Token, true, user) { }
        public RequestLoginTokenPacket(ByteBuffer buf, int length, QQUser user) : base(buf, length, user) { }
